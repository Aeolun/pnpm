...
test('getConfig() should read global inline SSL certs from .npmrc', async () => {
  prepareEmpty()
  ...
  console.log('Global ca:', config.ca)
  console.log('Global cert:', config.cert)
  console.log('Global key:', config.key)
})
